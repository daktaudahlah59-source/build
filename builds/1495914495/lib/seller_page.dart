...
class _SellerPageState extends State<SellerPage> {
  ...
  final Color cardGlass = const Color(0xFF0D1820);
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          Center(
            child: Container(
              decoration: BoxDecoration(gradient: cyanGradient, borderRadius: BorderRadius.circular(12)),
              child: TextButton(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildGlassCard(
                  ...
                  children: [
                    _buildInput(label: "Username Target", controller: editUsernameController, icon: FontAwesomeIcons.userEdit, hint: "Username member yang ingin diperpanjang"),
