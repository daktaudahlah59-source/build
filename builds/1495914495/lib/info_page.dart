...
class _InfoPageState extends State<InfoPage> {
  ...
  Future<void> _loadConfigAndFetch() async {
    ...
    try {
      ...
      // Setelah config loaded, fetch data dan start ping
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Gagal load config: $e"),
  ...
  Future<void> _fetchServerInfo() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://capekkenaoanyak.onlinepanel.my.id:2002/getServerInfo?key=${widget.sessionKey}'),
      );
  ...
  Future<void> _checkApiPing() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://capekkenaoanyak.onlinepanel.my.id:2002/ping?key=${widget.sessionKey}'),
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> rulesList = [
      ...
      },
      {
        ...
        "desc": "Dilarang merusak atau menurunkan harga yang telah ditentukan (banting harga) di bawah ketentuan DewaVerse."
      },
    ];
            ...
            Center(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(
                    "Peraturan ini dibuat untuk menjaga keamanan, kenyamanan, dan kestabilan ekosistem DewaVerse. Dengan menggunakan aplikasi ini, pengguna dianggap telah menyetujui seluruh peraturan di atas.",
                    style: TextStyle(
                      color: textGrey,
                      fontSize: 12,
