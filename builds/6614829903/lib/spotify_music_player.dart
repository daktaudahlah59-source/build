    ...
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        sliderTheme: SliderThemeData(
          ...
          activeTrackColor: const Color(0xFF0A84FF), // Biru menyala
        ...
        tabBarTheme: const TabBarThemeData(
          ...
          labelColor: Color(0xFF0A84FF), // Biru menyala
...
class _SpotifyMusicPlayerState extends State<SpotifyMusicPlayer>
  ...
  final Color _primaryColor = const Color(0xFF0A84FF); // Biru menyala
  final Color _primaryLight = const Color(0xFF409CFF);
  final Color _primaryDark = const Color(0xFF0066CC);
  ...
  Widget _buildDownloadIcon(String trackId) {
    if (_isDownloaded(trackId)) {
      return const Icon(Icons.offline_bolt_rounded, color: Color(0xFF0A84FF), size: 20);
    }
