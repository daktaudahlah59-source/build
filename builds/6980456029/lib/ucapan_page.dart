...
class _UcapanPageState extends State<UcapanPage> {
  ...
  // --- MODERN PURPLE THEME (46% Opacity Base for certain elements) ---
  static const Color bgDark = Color(0xFF000000);
  static const Color accentPurple = Color(0xFF9C27B0); // Ungu Utama
  static const Color darkPurple = Color(0xFF4A148C);   // Ungu Gelap
  static const Color softPurple = Color(0xFF7B1FA2);   // Ungu Lembut
  ...
  void _showSnackBar(String msg, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.grey.withOpacity(0.9) : accentPurple.withOpacity(0.9),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.person, color: accentPurple, size: 20),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: softGrey.withOpacity(0.5)),
                      prefixIcon: const Icon(Icons.edit_note, color: accentPurple, size: 20),
                      border: InputBorder.none,
                      contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
                    ),
                  ),
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: CustomPaint(
          ...
          child: _isLoading
              ? const Center(
                  child: CircularProgressIndicator(color: accentPurple, strokeWidth: 3),
                )
              : _ucapanList.isEmpty
                  ? Center(
                      child: TweenAnimationBuilder(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.card_giftcard_rounded, size: 70, color: accentPurple),
                            ),
                            const SizedBox(height: 20),
                            const Text(
                              'Belum ada ucapan',
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              const Icon(Icons.thumb_up_alt_outlined, color: accentPurple, size: 16),
                                              const SizedBox(width: 6),
                                              Text(
                                                '${ucapan.likes}',
                                                style: const TextStyle(color: accentPurple, fontSize: 12, fontWeight: FontWeight.w600),
                                              ),
                                            ],
                                          ),
                                        ),
