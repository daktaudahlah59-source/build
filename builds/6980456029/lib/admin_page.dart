...
class _AdminPageState extends State<AdminPage> {
  ...
  static const Color deleteColor = Color(0xFFCF6679); // Merah muda untuk delete (kontras)
      ...
      children: List.generate(totalPages, (index) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: currentPage == page ? purpleGradient : null,
              color: currentPage == page ? null : glassSecondary,
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                color: currentPage == page ? accentPurple : primaryWhite.withOpacity(0.1),
              ),
            ),
            child: Text(
              "$page",
                  ...
                  TweenAnimationBuilder(
                    ...
                    child: Column(
                      children: [
                        ...
                        ShaderMask(
                          shaderCallback: (bounds) => purpleGradient.createShader(bounds),
                          child: const Text(
                            "ADMIN DASHBOARD",
                            style: TextStyle(
                              color: primaryWhite,
