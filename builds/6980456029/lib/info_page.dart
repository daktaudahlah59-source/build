...
class _InfoPageState extends State<InfoPage> {
  ...
  Future<void> _checkApiPing() async {
    ...
    try {
      ...
      setState(() {
        isApiOnline = false;
        apiPingMs = 0;
        apiStatusColor = accentPurple; // Use theme color for offline
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> rulesList = [
      ...
      {"title": "Larangan Banting Harga", "desc": "Dilarang merusak atau menurunkan harga yang telah ditentukan (banting harga) di bawah ketentuan ATOMIC."},
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.info_outline_rounded, color: accentPurple, size: 18),
              ),
